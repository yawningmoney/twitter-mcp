...
async function selectResourceURL(serverUrl, provider, resourceMetadata) {
    let resource = (0, auth_utils_js_1.resourceUrlFromServerUrl)(serverUrl);
    if (provider.validateResourceURL) {
        ...
        if ((0, auth_utils_js_1.checkResourceAllowed)({ requestedResource: resource, configuredResource: resourceMetadata.resource })) {
